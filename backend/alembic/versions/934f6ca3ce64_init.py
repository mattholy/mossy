...
Revision ID: 934f6ca3ce64
Revises: 
Create Date: 2024-04-26 16:56:09.924164
...
def upgrade() -> None:
    ...
    sa.Column('operation_log_recored_id', sa.BigInteger(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_auth_permissions_operation_log_recored_id'), 'auth_permissions', ['operation_log_recored_id'], unique=False)
    ...
    sa.Column('section_1_content', sa.String(), nullable=True),
    sa.Column('section_2_title', sa.String(), nullable=True),
    sa.Column('section_2_content', sa.String(), nullable=True),
    sa.Column('section_3_title', sa.String(), nullable=True),
    sa.Column('section_3_content', sa.String(), nullable=True),
    sa.Column('section_4_title', sa.String(), nullable=True),
    sa.Column('section_4_content', sa.String(), nullable=True),
    sa.Column('section_verify', postgresql.BIT(length=4), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id'),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_auth_permissions_operation_log_recored_id'), table_name='auth_permissions')
